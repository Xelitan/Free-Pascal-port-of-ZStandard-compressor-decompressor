...
procedure qSort(var Arr; Count: Integer; Stride: Integer; CompareFunc: TCompareFunc);
...
procedure AnyQuickSort(var Arr; idxL, idxH: Integer;Stride: Integer; CompareFunc: TCompareFunc; var SwapBuf, MedBuf);
var
  ls,hs : Integer;
  li,hi : Integer;
  mi    : Integer;
